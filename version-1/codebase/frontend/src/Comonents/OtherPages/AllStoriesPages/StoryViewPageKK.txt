              ...
              <div key={story?.id}>
                ...
                <div className="relative w-[396px] overflow-hidden">
                  <div className="flex transition-transform duration-500 gap-4">
                    <div className="w-[396px] h-[650px] flex-shrink-0">
                      ...
                      <div className="flex flex-col items-center justify-between absolute bottom-0 z-10 w-[396px] px-4 py-[10px] bg-white shadow-lg rounded-t-[16px]">
                        <div className="border-b-2 border-b-gray flex items-center justify-between w-full">
                          ...
                          <p
                            ...
                            // onClick={() => setIsShowvisibleStoryViewID(story?.id)}
                          >
                            {story?.viewers?.length > 0 ? isShowvisibleStoryViewID ? "Hide" : "See more" : ""}
                            {/* {isShowvisibleStoryViewID ? "Hide" : "See more"} */}
                          </p>
                        </div>
                        {isShowvisibleStoryViewID && 
                         story.viewers.map((viewerData, viewerIndex) => {
                            return (
                                <div className="flex items-center gap-[8px] my-4 w-full" key={viewerIndex}>
                                  <div>
                                    <img
